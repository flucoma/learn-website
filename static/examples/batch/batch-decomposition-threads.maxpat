...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 101.5, 531.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "5",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 124.5, 76.0, 373.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 486.5, 107.0, 56.0, 22.0 ],
									"text" : "buffer~ p"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 426.5, 107.0, 56.0, 22.0 ],
									"text" : "buffer~ h"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 23.5, 75.0, 95.0, 22.0 ],
									"text" : "source $1, bang"
								}
...
, 							{
								"box" : 								{
									...
									"border" : 2,
									"bordercolor" : [ 0.670588235294118, 0.909803921568627, 1.0, 1.0 ],
									"id" : "obj-124",
									"maxclass" : "panel",
									"mode" : 0,
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 23.5, 15.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 33.0, 142.0, 154.0, 142.0 ],
									"order" : 0,
									"source" : [ "obj-23", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 33.0, 130.0, 33.0, 130.0 ],
									"order" : 1,
									"source" : [ "obj-23", 0 ]
								}
...
,
					"patching_rect" : [ 37.0, 530.0, 62.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 100.5, 447.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "4",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 121.0, 445.5, 273.0, 24.0 ],
					"text" : "Look in here to see how iteration is managed."
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 166.0, 502.0, 118.0, 22.0 ],
									"text" : "Processing buffer $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 149.0, 307.0, 277.0, 60.0 ],
									"text" : "We check here if the value of the counter is less than or equal to the number of items in the coll. If it isn't we send a 0 which closes the gate. This stops a new item from being processed."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 149.0, 245.0, 277.0, 47.0 ],
									"text" : "This counter will increment everytime it receives a bang. This happens for the first item, and then everytime an item completes."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 149.0, 175.0, 273.0, 60.0 ],
									"text" : "Reset the counter to one and feed the number of items in the coll value to the <= below. This will be used as a way of stopping the iteration through coll items."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 312.0, 499.0, 153.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 166.0, 542.0, 32.0, 22.0 ],
									"text" : "print"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 72.0, 98.0, 273.0, 20.0 ],
									"text" : "Get the number of items stored in the coll."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 16.0, 462.0, 132.0, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0,
										"precision" : 6
									}
,
									"text" : "coll source_information"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 29.0, 175.0, 110.0, 22.0 ],
									"text" : "t b 1 i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 29.0, 95.0, 41.0, 22.0 ],
									"text" : "length"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 312.0, 462.0, 34.0, 22.0 ],
									"text" : "sel 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 29.0, 295.0, 49.0, 22.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 16.0, 405.0, 32.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 59.0, 345.0, 80.0, 22.0 ],
									"text" : "<= 10"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 29.0, 245.0, 60.0, 22.0 ],
									"text" : "counter"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 29.0, 135.0, 132.0, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0,
										"precision" : 6
									}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 16.0, 505.0, 30.0, 30.0 ]
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 175.5, 525.0, 175.5, 525.0 ],
									"source" : [ "obj-107", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 38.5, 159.0, 38.5, 159.0 ],
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 106.5, 81.0, 15.0, 81.0, 15.0, 231.0, 38.5, 231.0 ],
									"source" : [ "obj-132", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 68.5, 390.0, 25.5, 390.0 ],
									"order" : 1,
									"source" : [ "obj-41", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 68.5, 447.0, 321.5, 447.0 ],
									"order" : 0,
									"source" : [ "obj-41", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 25.5, 429.0, 25.5, 429.0 ],
									"order" : 1,
									"source" : [ "obj-43", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 25.5, 447.0, 175.5, 447.0 ],
									"order" : 0,
									"source" : [ "obj-43", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 68.5, 318.0, 68.5, 318.0 ],
									"source" : [ "obj-44", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 321.5, 486.0, 321.5, 486.0 ],
									"source" : [ "obj-45", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 84.0, 231.0, 59.0, 231.0 ],
									"source" : [ "obj-60", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-20", 0 ],
									"midpoints" : [ 38.5, 198.0, 38.5, 198.0 ],
									"source" : [ "obj-60", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 175.5, 486.0, 175.5, 486.0 ],
									"source" : [ "obj-93", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-94", 0 ],
									"midpoints" : [ 321.5, 537.0, 175.5, 537.0 ],
									"source" : [ "obj-96", 0 ]
								}
...
,
					"patching_rect" : [ 37.0, 447.5, 56.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 37.0, 396.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 610.0, 54.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.0, 398.0, 273.0, 24.0 ],
					"text" : "Start decomposition of all polybuffer~ buffers~."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 67.0, 398.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 940.0, 403.0, 184.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 917.25, 411.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "4",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 834.25, 206.0, 364.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 812.0, 212.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "6",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 191.0, 254.5, 254.5, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.5, 214.0, 406.0, 37.0 ],
					"text" : "Dump the contents of the polybuffer~ audiofiles into a coll. Also setup a polybuffer~ called results which will store the decomposition outputs."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 63.5, 222.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 950.25, 281.5, 132.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 37.0, 344.5, 132.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 770.25, 311.5, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 770.25, 338.5, 29.5, 22.0 ],
					"text" : "t 1 l"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 687.0, 125.0, 102.0, 22.0 ],
									"text" : "texton #2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 602.0, 125.0, 89.0, 22.0 ],
									"text" : "text #2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 502.0, 125.0, 94.0, 22.0 ],
									"text" : "texton #1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 423.0, 125.0, 81.0, 22.0 ],
									"text" : "text #1"
								}
...
,
					"patching_rect" : [ 770.25, 411.5, 144.5, 23.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 770.25, 281.5, 167.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 760.0, 211.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 770.25, 451.5, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 770.25, 371.5, 144.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 37.0, 220.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 167.0, 300.0, 107.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 37.0, 260.0, 149.0, 22.0 ],
					"text" : "t dump clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 37.0, 300.0, 122.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 16.0, 108.0, 128.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 0.2, 0.2, 0.2, 0.0 ],
					"border" : 2,
					"bordercolor" : [ 0.427450980392157, 0.152941176470588, 0.152941176470588, 1.0 ],
					"id" : "obj-127",
					"maxclass" : "panel",
					"mode" : 0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 750.0, 200.0, 460.0, 311.5 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 200.0, 500.0, 529.0 ],
					"proportion" : 0.5
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 46.5, 486.0, 482.0, 486.0 ],
					"order" : 0,
					"source" : [ "obj-134", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 46.5, 337.0, 46.5, 337.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 769.5, 268.5, 927.75, 268.5 ],
					"order" : 1,
					"source" : [ "obj-65", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 769.5, 268.5, 959.75, 268.5 ],
					"order" : 0,
					"source" : [ "obj-65", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 46.5, 633.0, 24.0, 633.0, 24.0, 432.0, 83.5, 432.0 ],
					"source" : [ "obj-82", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-46::obj-15" : [ "live.text[4]", "live.text", 0 ],
			"obj-46::obj-16" : [ "live.text[5]", "live.text", 0 ],
			"parameterbanks" : 			{

...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 722.5, 220.0, 669.0, 20.0 ],
					"text" : "Add the end of the file (in samples) as a slice manually, so that we slice to analyse the final slice to the end of the file always."
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 14.0, 174.0, 138.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 14.0, 127.0, 63.5, 22.0 ],
									"text" : "join"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 14.0, 49.0, 63.5, 22.0 ],
									"text" : "t l b"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 116.5, 127.0, 77.0, 22.0 ],
									"text" : "buffer~ drum"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 58.5, 85.0, 135.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 14.0, 218.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 592.5, 220.0, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 872.5, 830.0, 471.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 918.5, 270.0, 474.0, 167.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 740.5, 820.0, 122.0, 179.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 592.5, 270.0, 139.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 652.5, 310.0, 67.0, 22.0 ],
					"text" : "zl.stream 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 652.5, 344.0, 29.5, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 816.0, 417.0, 85.0, 22.0 ],
					"text" : "numframes $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 717.5, 417.0, 79.0, 22.0 ],
					"text" : "startframe $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 717.5, 383.0, 47.0, 22.0 ],
					"text" : "zl.nth 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 585.5, 260.0, 327.0, 190.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 662.0, 334.0, 662.0, 334.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 825.5, 406.0, 825.5, 406.0 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 727.0, 406.0, 727.0, 406.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 727.0, 442.0, 662.0, 442.0 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 0 ],
					"midpoints" : [ 825.5, 442.0, 662.0, 442.0 ],
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 0 ],
					"midpoints" : [ 662.0, 367.0, 662.0, 367.0 ],
					"source" : [ "obj-51", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 672.5, 367.0, 825.5, 367.0 ],
					"order" : 0,
					"source" : [ "obj-51", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 672.5, 379.0, 727.0, 379.0 ],
					"order" : 1,
					"source" : [ "obj-51", 1 ]
				}

...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 451.0, 668.0, 50.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 43.0, 150.0, 690.0, 50.0 ],
					"text" : "If all of these objects are loaded and there are no errors in your Max window then you should be good to go."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 134.0, 400.0, 153.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "float", "" ],
					"patching_rect" : [ 15.0, 400.0, 112.0, 29.0 ],
					"text" : "fluid.bufnmf~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "float", "" ],
					"patching_rect" : [ 302.0, 358.0, 156.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "float", "" ],
					"patching_rect" : [ 171.0, 358.0, 120.0, 29.0 ],
					"text" : "fluid.kmeans~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "float", "" ],
					"patching_rect" : [ 15.0, 358.0, 150.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 146.0, 668.0, 201.0 ],
					"presentation" : 1,
					"presentation_linecount" : 9,
					"presentation_rect" : [ 28.0, 135.0, 690.0, 201.0 ],
					"text" : "This is a test page to make sure that the FluCoMa externals are installed and will work on your system. All of the objects below should load and should not be orange. If they are, first check the Max console (Cmd + M) and then send us an e-mail so we can help you.\n\nj.bradbury@hud.ac.uk\nt.moore@hud.ac.uk\no.green@hud.ac.uk\np.a.tremblay@hud.ac.uk"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 382.433868000000018, 60.378662819722109, 289.566131999999982, 64.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 317.5, 48.378663000000003, 696.0, 64.0 ],
					"text" : "Install Test"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 17.0, 288.351253092288971, 98.378662819722109 ],
					"pic" : "fluidcorpusmanipulation.png",
					"presentation" : 1,
					"presentation_rect" : [ 13.0, 14.0, 288.351253092288971, 98.378662819722109 ]
				}

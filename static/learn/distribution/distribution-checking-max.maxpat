...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 805.0, 98.5, 159.0, 47.0 ],
					"text" : "3. click through the different dimensions in the data set to see each's histogram"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 429.0, 15.5, 113.0, 47.0 ],
					"text" : "2. prepare the data for analysis and send it to the dict"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 584.166666666666629, 47.5, 101.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 584.166666666666629, 16.5, 52.0, 22.0 ],
					"text" : "get data"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 197.0, 260.5, 75.0, 22.0 ],
					"text" : "buffer~ mfcc"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 14.0, 83.5, 111.0, 89.0 ],
					"text" : "fluid.bufmfcc~ 60 @source src @numcoeffs 60 @startcoeff 1 @features mfcc @numbands 120"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 14.0, 260.5, 173.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 695.0, 165.5, 146.0, 22.0 ],
					"text" : "t b i clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 695.0, 98.5, 98.0, 52.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 664.0, 105.039999999999992, 118.0, 52.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 14.0, 15.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 14.0, 52.5, 51.0, 22.0 ],
					"text" : "t b clear"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-32",
					"ignoreclick" : 1,
					"linecolor" : [ 1.0, 0.015686274509804, 0.015686274509804, 1.0 ],
					"maxclass" : "itable",
					"name" : "",
					"numinlets" : 2,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 611.5, 165.5, 55.0, 22.0 ],
					"text" : "zl.slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 611.5, 128.5, 47.0, 22.0 ],
					"text" : "dict.iter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 611.5, 87.5, 63.0, 22.0 ],
					"text" : "route data"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 14.0, 225.5, 107.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 704.5, 198.0, 569.0, 198.0, 569.0, 12.0, 593.666666666666629, 12.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 657.0, 450.0, 657.0, 450.0 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 657.0, 411.0, 657.0, 411.0 ],
					"source" : [ "obj-39", 0 ]
				}
